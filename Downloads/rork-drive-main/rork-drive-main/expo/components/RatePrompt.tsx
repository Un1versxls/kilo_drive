/* RatePrompt component disabled for production release per App Store guideline 2.2 
   Beta testing features (app rating prompts) are not appropriate for production versions.
   Re-enable only for beta/preview builds.
...
// Dummy component for production release - no-op to satisfy imports
export function RatePrompt() {
  return null;
}
